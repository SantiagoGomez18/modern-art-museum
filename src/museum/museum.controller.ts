...
import { BusinessErrorsInterceptor } from '../shared/interceptors/interceptors.interceptor';
...
export class MuseumController {
  ...
  async findAll(
    ...
    return await this.museumService.findAll({ city, name, foundedBefore: foundedBefore, page, limit });
  }
